		...
		<div class="card" style="cursor: default; background-color: transparent; border-color: transparent;">
			<div class="card-body">
				<div class="text-center" style="margin-bottom: 1em;">
					<img src="../bank/bpi.png" style="height: 70px;">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<form id="frmInputs">
					        <input type="text" name="txtnmBank" id="inputnmBank" value="BPI" hidden>
							<div class="form-floating">
								<input type="text" name="txtCheckno" class="form-control" id="inputnmCheckno" placeholder="Check No." autocomplete="off" required style="color: maroon;">
							...
							<div class="form-floating" hidden>
								<input type="text" name="txtnmAccountno" class="form-control" id="inputnmAccountno" placeholder="Account No" autocomplete="off" required style="color: maroon;">
							...
							<div class="form-floating">
								<input type="text" name="txtAccountname" class="form-control" id="inputnmAccountname" placeholder="Account Name" autocomplete="off" required style="color: maroon;">
								<label for="inputnmAccountname"><img src="../icons/user.png"> Account Name</label>
							</div>
							<div class="form-floating">
								<input type="text" name="txtAmount" class="form-control" id="inputnmAmount" placeholder="Amount" autocomplete="off"  required style="color: maroon;">
								<label for="inputnmAmount"><img src="../icons/money.png"> Amount</label>
							</div>
							<div class="form-floating">
								<input type="date" name="txtCheckdate" class="form-control" id="inputnmCheckdate" placeholder="Check Date" autocomplete="off"  required style="color: maroon;">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<a href="BPIchecksummary" style="text-decoration: none;">
